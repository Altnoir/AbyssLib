...
/**
 * 分区栏标题渲染（照 MIA-26.1 SectionedCreativeTabRenderer 移植）。
 *
 * <p>由 {@code CreativeModeInventoryScreenMixin} 在
 * {@code CreativeModeInventoryScreen.extractBackground} 末尾调用 {@link #extract}：
