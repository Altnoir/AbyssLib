...
public class ItemBuilder<T extends Item, P> extends AbstractBuilder<Item, T, P, ItemBuilder<T, P>> {
    ...
    public ItemBuilder<T, P> color(NonNullSupplier<Supplier<ItemColor>> colorHandler) {
        if (this.colorHandler == null) {
            ReginthDistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> this::registerItemColor);
        }
     ...
     */
    public ItemBuilder<T, P> model(NonNullBiConsumer<DataGenContext<Item, T>, ReginthItemModelProvider> cons) {
