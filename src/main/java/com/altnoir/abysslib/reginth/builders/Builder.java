 ...
 * <p>
 * When a builder is completed via {@link #register()} or {@link #build()}, the object will be lazily registered (through the owning {@link AbstractReginth} object).
 * 
 * @param <R>
...
public interface Builder<R, T extends R, P, S extends Builder<R, T, P, S>> extends NonNullSupplier<RegistryEntry<R, T>> {
    ...
    /**
     * The owning {@link AbstractReginth} that created this builder.
     * 
     * @return the owner {@link AbstractReginth}
     */
    AbstractReginth<?> getOwner();
    ...
    /**
     * The name of the entry being created, and combined with the mod ID of the parent {@link AbstractReginth}, the registry name.
     * 
    ...
    default <D extends ReginthProvider> S setData(ProviderType<? extends D> type, NonNullBiConsumer<DataGenContext<R, T>, D> cons) {
     ...
     */
    @SuppressWarnings("unchecked")
    default <D extends ReginthProvider> S addMiscData(ProviderType<? extends D> type, NonNullConsumer<? extends D> cons) {
    ...
    /**
     * Register the entry and return the parent object. The {@link net.neoforged.neoforge.registries.DeferredHolder} will be created but not returned. It can be retrieved later with {@link AbstractReginth#get(ResourceKey)} or
     * {@link AbstractReginth#get(String, ResourceKey)}.
     * 
