...
//     */
//    public static <T extends Biome, P> BiomeBuilder<T, P> create(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, NonNullFunction<Biome.Builder, T> factory) {
...
//
//    protected BiomeBuilder(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, NonNullFunction<Biome.Builder, T> factory) {
...
//
//    /**
//     * Assign the default translation, as specified by {@link ReginthLangProvider#getAutomaticName(NonNullSupplier)}. This is the default, so it is generally not necessary to call, unless for
