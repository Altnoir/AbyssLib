...
/**
 * Wraps a {@link net.neoforged.neoforge.registries.DeferredHolder}, providing a cleaner API with null-safe access, and Reginth-specific extensions such as {@link #getSibling(ResourceKey)}.
 *
 * @param <S>
...
public class RegistryEntry<R, S extends R> extends DeferredHolder<R, S> implements NonNullSupplier<S> {
    ...
    public RegistryEntry(AbstractReginth<?> owner, DeferredHolder<R, S> key) {
        super(key.getKey());
