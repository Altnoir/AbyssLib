...
public class OneTimeEventReceiver<T extends Event> implements Consumer<@NonnullType T> {
    ...
    public static <T extends Event & IModBusEvent> void addModListener(AbstractReginth<?> owner, Class<? super T> evtClass, Consumer<? super T> listener) {
        OneTimeEventReceiver.<T>addModListener(owner, EventPriority.NORMAL, evtClass, listener);
    }

    public static <T extends Event & IModBusEvent> void addModListener(AbstractReginth<?> owner, EventPriority priority, Class<? super T> evtClass, Consumer<? super T> listener) {
    ...
    private static final Table<AbstractReginth<?>, Class<?>, List<Pair<EventPriority, Consumer<?>>>> waitingModListeners = HashBasedTable.create();
    ...
    public static synchronized void unregister(AbstractReginth<?> owner, Object listener, Class<? extends Event> event) {
