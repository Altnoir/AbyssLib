...
public class ReginthBlockstateProvider extends BlockStateProvider implements ReginthProvider {

    private final AbstractReginth<?> parent;

    public ReginthBlockstateProvider(AbstractReginth<?> parent, PackOutput packOutput, ExistingFileHelper exFileHelper) {
