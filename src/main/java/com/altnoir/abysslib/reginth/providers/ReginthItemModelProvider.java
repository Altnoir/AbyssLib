...
public class ReginthItemModelProvider extends ItemModelProvider implements ReginthProvider {

    private final AbstractReginth<?> parent;

    public ReginthItemModelProvider(AbstractReginth<?> parent, PackOutput packOutput, ExistingFileHelper existingFileHelper) {
