...
import com.altnoir.abysslib.reginth.util.DataIngredient;
...
public class ReginthRecipeProvider extends RecipeProvider implements ReginthProvider, RecipeOutput {
	private final AbstractReginth<?> owner;
	private HolderLookup.Provider provider;

	public ReginthRecipeProvider(AbstractReginth<?> owner, PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
	...
	private static final ImmutableMap<RecipeSerializer<? extends AbstractCookingRecipe>, String> COOKING_TYPE_NAMES = ImmutableMap.<RecipeSerializer<? extends AbstractCookingRecipe>, String>builder().put(RecipeSerializer.SMELTING_RECIPE, "smelting").put(RecipeSerializer.BLASTING_RECIPE, "blasting").put(RecipeSerializer.SMOKING_RECIPE, "smoking").put(RecipeSerializer.CAMPFIRE_COOKING_RECIPE, "campfire").build();
	...
	public <T extends ItemLike, S extends AbstractCookingRecipe> void cooking(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime, String typeName, RecipeSerializer<S> serializer, AbstractCookingRecipe.Factory<S> factory) {
		SimpleCookingRecipeBuilder.generic(source.toVanilla(), category, result.get(), experience, cookingTime, serializer, factory).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()) + "_from_" + safeName(source) + "_" + typeName);
	}
	...
	public <T extends ItemLike> void stonecutting(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int resultAmount) {
		SingleItemRecipeBuilder.stonecutting(source.toVanilla(), category, result.get(), resultAmount).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()) + "_from_" + safeName(source) + "_stonecutting");
	}
	...
	public <T extends ItemLike> void square(DataIngredient source, RecipeCategory category, Supplier<? extends T> output, boolean small) {
		...
		builder.unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(output.get()));
	}
	...
	public <T extends ItemLike> void storage(DataIngredient sourceIngredient, RecipeCategory category, NonNullSupplier<? extends T> source, DataIngredient outputIngredient, NonNullSupplier<? extends T> output) {
		...
		singleItemUnfinished(outputIngredient, category, source, 1, 9).save(this, safeId(sourceIngredient) + "_from_" + safeName(output.get()));
	}
	...
	public <T extends ItemLike> ShapelessRecipeBuilder singleItemUnfinished(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int required, int amount) {
		return ShapelessRecipeBuilder.shapeless(category, result.get(), amount).requires(source.toVanilla(), required).unlockedBy("has_" + safeName(source), source.getCriterion(this));
	}
	...
	public <T extends ItemLike> void planks(DataIngredient source, RecipeCategory category, Supplier<? extends T> result) {
		singleItemUnfinished(source, category, result, 1, 4).group("planks").save(this, safeId(result.get()));
	}
	...
	public <T extends ItemLike> void stairs(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group, boolean stone) {
		ShapedRecipeBuilder.shaped(category, result.get(), 4).pattern("X  ").pattern("XX ").pattern("XXX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()));
		if (stone) {
	...
	public <T extends ItemLike> void slab(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group, boolean stone) {
		ShapedRecipeBuilder.shaped(category, result.get(), 6).pattern("XXX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()));
		if (stone) {
	...
	public <T extends ItemLike> void fence(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
		ShapedRecipeBuilder.shaped(category, result.get(), 3).pattern("W#W").pattern("W#W").define('W', source.toVanilla()).define('#', Tags.Items.RODS_WOODEN).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()));
	}
	...
	public <T extends ItemLike> void fenceGate(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
		ShapedRecipeBuilder.shaped(category, result.get()).pattern("#W#").pattern("#W#").define('W', source.toVanilla()).define('#', Tags.Items.RODS_WOODEN).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()));
	}

	public <T extends ItemLike> void wall(DataIngredient source, RecipeCategory category, Supplier<? extends T> result) {
		ShapedRecipeBuilder.shaped(category, result.get(), 6).pattern("XXX").pattern("XXX").define('X', source.toVanilla()).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()));
		stonecutting(source, category, result);
	}
	...
	public <T extends ItemLike> void door(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
		ShapedRecipeBuilder.shaped(category, result.get(), 3).pattern("XX").pattern("XX").pattern("XX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()));
	}
	...
	public <T extends ItemLike> void trapDoor(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
		ShapedRecipeBuilder.shaped(category, result.get(), 2).pattern("XXX").pattern("XXX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()));
	}
	...
	public CompletableFuture<?> buildAdvancement(CachedOutput p_253674_, HolderLookup.Provider p_323646_, AdvancementHolder p_301116_) {
		return super.buildAdvancement(p_253674_, p_323646_, p_301116_);
	}
	 ...
	 */
	@Override
	public CompletableFuture<?> buildAdvancement(CachedOutput p_253674_, HolderLookup.Provider p_323646_, AdvancementHolder p_301116_, net.neoforged.neoforge.common.conditions.ICondition... conditions) {
		return super.buildAdvancement(p_253674_, p_323646_, p_301116_, conditions);
	}
	 ...
	 */
	@Override
	public void generateForEnabledBlockFamilies(RecipeOutput p_301146_, FeatureFlagSet p_251836_) {
		super.generateForEnabledBlockFamilies(p_301146_, p_251836_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#netheriteSmithing}
	 */
	public static void netheriteSmithing(RecipeOutput p_300886_, Item p_250046_, RecipeCategory p_248986_, Item p_250389_) {
		RecipeProvider.netheriteSmithing(p_300886_, p_250046_, p_248986_, p_250389_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#trimSmithing}
	 */
	public static void trimSmithing(RecipeOutput p_301332_, Item p_285461_, ResourceLocation p_285044_) {
		RecipeProvider.trimSmithing(p_301332_, p_285461_, p_285044_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#twoByTwoPacker}
	 */
	public static void twoByTwoPacker(RecipeOutput p_301022_, RecipeCategory p_250881_, ItemLike p_252184_, ItemLike p_249710_) {
		RecipeProvider.twoByTwoPacker(p_301022_, p_250881_, p_252184_, p_249710_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#threeByThreePacker}
	 */
	public static void threeByThreePacker(RecipeOutput p_301298_, RecipeCategory p_259247_, ItemLike p_259376_, ItemLike p_259717_, String p_260308_) {
		RecipeProvider.threeByThreePacker(p_301298_, p_259247_, p_259376_, p_259717_, p_260308_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#threeByThreePacker}
	 */
	public static void threeByThreePacker(RecipeOutput p_301302_, RecipeCategory p_259186_, ItemLike p_259360_, ItemLike p_259263_) {
		RecipeProvider.threeByThreePacker(p_301302_, p_259186_, p_259360_, p_259263_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#planksFromLog}
	 */
	public static void planksFromLog(RecipeOutput p_301020_, ItemLike p_259052_, TagKey<Item> p_259045_, int p_259471_) {
		RecipeProvider.planksFromLog(p_301020_, p_259052_, p_259045_, p_259471_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#planksFromLogs}
	 */
	public static void planksFromLogs(RecipeOutput p_301221_, ItemLike p_259193_, TagKey<Item> p_259818_, int p_259807_) {
		RecipeProvider.planksFromLogs(p_301221_, p_259193_, p_259818_, p_259807_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#woodFromLogs}
	 */
	public static void woodFromLogs(RecipeOutput p_301095_, ItemLike p_126004_, ItemLike p_126005_) {
		RecipeProvider.woodFromLogs(p_301095_, p_126004_, p_126005_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#woodenBoat}
	 */
	public static void woodenBoat(RecipeOutput p_301315_, ItemLike p_126023_, ItemLike p_126024_) {
		RecipeProvider.woodenBoat(p_301315_, p_126023_, p_126024_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#chestBoat}
	 */
	public static void chestBoat(RecipeOutput p_300996_, ItemLike p_236373_, ItemLike p_236374_) {
		RecipeProvider.chestBoat(p_300996_, p_236373_, p_236374_);
	}
	...
	public static RecipeBuilder buttonBuilder(ItemLike p_176659_, Ingredient p_176660_) {
		return RecipeProvider.buttonBuilder(p_176659_, p_176660_);
	}
	...
	public static RecipeBuilder doorBuilder(ItemLike p_176671_, Ingredient p_176672_) {
		return RecipeProvider.doorBuilder(p_176671_, p_176672_);
	}
	...
	public static RecipeBuilder fenceBuilder(ItemLike p_176679_, Ingredient p_176680_) {
		return RecipeProvider.fenceBuilder(p_176679_, p_176680_);
	}
	...
	public static RecipeBuilder fenceGateBuilder(ItemLike p_176685_, Ingredient p_176686_) {
		return RecipeProvider.fenceGateBuilder(p_176685_, p_176686_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#pressurePlate}
	 */
	public static void pressurePlate(RecipeOutput p_301211_, ItemLike p_176692_, ItemLike p_176693_) {
		RecipeProvider.pressurePlate(p_301211_, p_176692_, p_176693_);
	}
	...
	public static RecipeBuilder pressurePlateBuilder(RecipeCategory p_251447_, ItemLike p_251989_, Ingredient p_249211_) {
		return RecipeProvider.pressurePlateBuilder(p_251447_, p_251989_, p_249211_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#slab}
	 */
	public static void slab(RecipeOutput p_300949_, RecipeCategory p_251848_, ItemLike p_249368_, ItemLike p_252133_) {
		RecipeProvider.slab(p_300949_, p_251848_, p_249368_, p_252133_);
	}
	...
	public static RecipeBuilder slabBuilder(RecipeCategory p_251707_, ItemLike p_251284_, Ingredient p_248824_) {
		return RecipeProvider.slabBuilder(p_251707_, p_251284_, p_248824_);
	}
	...
	public static RecipeBuilder stairBuilder(ItemLike p_176711_, Ingredient p_176712_) {
		return RecipeProvider.stairBuilder(p_176711_, p_176712_);
	}
	...
	public static RecipeBuilder trapdoorBuilder(ItemLike p_176721_, Ingredient p_176722_) {
		return RecipeProvider.trapdoorBuilder(p_176721_, p_176722_);
	}
	...
	public static RecipeBuilder signBuilder(ItemLike p_176727_, Ingredient p_176728_) {
		return RecipeProvider.signBuilder(p_176727_, p_176728_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#hangingSign}
	 */
	public static void hangingSign(RecipeOutput p_301272_, ItemLike p_252355_, ItemLike p_250437_) {
		RecipeProvider.hangingSign(p_301272_, p_252355_, p_250437_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#colorBlockWithDye}
	 */
	public static void colorBlockWithDye(RecipeOutput p_301260_, List<Item> p_289675_, List<Item> p_289672_, String p_289641_) {
		RecipeProvider.colorBlockWithDye(p_301260_, p_289675_, p_289672_, p_289641_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#carpet}
	 */
	public static void carpet(RecipeOutput p_300953_, ItemLike p_176718_, ItemLike p_176719_) {
		RecipeProvider.carpet(p_300953_, p_176718_, p_176719_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#bedFromPlanksAndWool}
	 */
	public static void bedFromPlanksAndWool(RecipeOutput p_301140_, ItemLike p_126075_, ItemLike p_126076_) {
		RecipeProvider.bedFromPlanksAndWool(p_301140_, p_126075_, p_126076_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#banner}
	 */
	public static void banner(RecipeOutput p_301322_, ItemLike p_126083_, ItemLike p_126084_) {
		RecipeProvider.banner(p_301322_, p_126083_, p_126084_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#stainedGlassFromGlassAndDye}
	 */
	public static void stainedGlassFromGlassAndDye(RecipeOutput p_300895_, ItemLike p_126087_, ItemLike p_126088_) {
		RecipeProvider.stainedGlassFromGlassAndDye(p_300895_, p_126087_, p_126088_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#stainedGlassPaneFromStainedGlass}
	 */
	public static void stainedGlassPaneFromStainedGlass(RecipeOutput p_301233_, ItemLike p_126091_, ItemLike p_126092_) {
		RecipeProvider.stainedGlassPaneFromStainedGlass(p_301233_, p_126091_, p_126092_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#stainedGlassPaneFromGlassPaneAndDye}
	 */
	public static void stainedGlassPaneFromGlassPaneAndDye(RecipeOutput p_301038_, ItemLike p_126095_, ItemLike p_126096_) {
		RecipeProvider.stainedGlassPaneFromGlassPaneAndDye(p_301038_, p_126095_, p_126096_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#coloredTerracottaFromTerracottaAndDye}
	 */
	public static void coloredTerracottaFromTerracottaAndDye(RecipeOutput p_300948_, ItemLike p_126099_, ItemLike p_126100_) {
		RecipeProvider.coloredTerracottaFromTerracottaAndDye(p_300948_, p_126099_, p_126100_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#concretePowder}
	 */
	public static void concretePowder(RecipeOutput p_301177_, ItemLike p_126103_, ItemLike p_126104_) {
		RecipeProvider.concretePowder(p_301177_, p_126103_, p_126104_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#candle}
	 */
	public static void candle(RecipeOutput p_301024_, ItemLike p_176544_, ItemLike p_176545_) {
		RecipeProvider.candle(p_301024_, p_176544_, p_176545_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#wall}
	 */
	public static void wall(RecipeOutput p_301176_, RecipeCategory p_251148_, ItemLike p_250499_, ItemLike p_249970_) {
		RecipeProvider.wall(p_301176_, p_251148_, p_250499_, p_249970_);
	}
	...
	public static RecipeBuilder wallBuilder(RecipeCategory p_249083_, ItemLike p_250754_, Ingredient p_250311_) {
		return RecipeProvider.wallBuilder(p_249083_, p_250754_, p_250311_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#polished}
	 */
	public static void polished(RecipeOutput p_301100_, RecipeCategory p_248719_, ItemLike p_250032_, ItemLike p_250021_) {
		RecipeProvider.polished(p_301100_, p_248719_, p_250032_, p_250021_);
	}
	...
	public static RecipeBuilder polishedBuilder(RecipeCategory p_249131_, ItemLike p_251242_, Ingredient p_251412_) {
		return RecipeProvider.polishedBuilder(p_249131_, p_251242_, p_251412_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#cut}
	 */
	public static void cut(RecipeOutput p_301189_, RecipeCategory p_252306_, ItemLike p_249686_, ItemLike p_251100_) {
		RecipeProvider.cut(p_301189_, p_252306_, p_249686_, p_251100_);
	}
	...
	public static ShapedRecipeBuilder cutBuilder(RecipeCategory p_250895_, ItemLike p_251147_, Ingredient p_251563_) {
		return RecipeProvider.cutBuilder(p_250895_, p_251147_, p_251563_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#chiseled}
	 */
	public static void chiseled(RecipeOutput p_300911_, RecipeCategory p_251604_, ItemLike p_251049_, ItemLike p_252267_) {
		RecipeProvider.chiseled(p_300911_, p_251604_, p_251049_, p_252267_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#mosaicBuilder}
	 */
	public static void mosaicBuilder(RecipeOutput p_301088_, RecipeCategory p_248788_, ItemLike p_251925_, ItemLike p_252242_) {
		RecipeProvider.mosaicBuilder(p_301088_, p_248788_, p_251925_, p_252242_);
	}
	...
	public static ShapedRecipeBuilder chiseledBuilder(RecipeCategory p_251755_, ItemLike p_249782_, Ingredient p_250087_) {
		return RecipeProvider.chiseledBuilder(p_251755_, p_249782_, p_250087_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#stonecutterResultFromBase}
	 */
	public static void stonecutterResultFromBase(RecipeOutput p_301035_, RecipeCategory p_248911_, ItemLike p_251265_, ItemLike p_250033_) {
		RecipeProvider.stonecutterResultFromBase(p_301035_, p_248911_, p_251265_, p_250033_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#stonecutterResultFromBase}
	 */
	public static void stonecutterResultFromBase(RecipeOutput p_301195_, RecipeCategory p_250609_, ItemLike p_251254_, ItemLike p_249666_, int p_251462_) {
		RecipeProvider.stonecutterResultFromBase(p_301195_, p_250609_, p_251254_, p_249666_, p_251462_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#smeltingResultFromBase}
	 */
	public static void smeltingResultFromBase(RecipeOutput p_300916_, ItemLike p_176741_, ItemLike p_176742_) {
		RecipeProvider.smeltingResultFromBase(p_300916_, p_176741_, p_176742_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#copySmithingTemplate}
	 */
	public static void copySmithingTemplate(RecipeOutput p_300986_, ItemLike p_266974_, TagKey<Item> p_267283_) {
		RecipeProvider.copySmithingTemplate(p_300986_, p_266974_, p_267283_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#copySmithingTemplate}
	 */
	public static void copySmithingTemplate(RecipeOutput p_301265_, ItemLike p_267133_, ItemLike p_267023_) {
		RecipeProvider.copySmithingTemplate(p_301265_, p_267133_, p_267023_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#copySmithingTemplate}
	 */
	public static void copySmithingTemplate(RecipeOutput p_350466_, ItemLike p_350799_, Ingredient p_350344_) {
		RecipeProvider.copySmithingTemplate(p_350466_, p_350799_, p_350344_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#waxRecipes}
	 */
	public static void waxRecipes(RecipeOutput p_301254_, FeatureFlagSet p_313879_) {
		RecipeProvider.waxRecipes(p_301254_, p_313879_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#grate}
	 */
	public static void grate(RecipeOutput p_309012_, Block p_309021_, Block p_309140_) {
		RecipeProvider.grate(p_309012_, p_309021_, p_309140_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#copperBulb}
	 */
	public static void copperBulb(RecipeOutput p_308971_, Block p_309026_, Block p_308866_) {
		RecipeProvider.copperBulb(p_308971_, p_309026_, p_308866_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#generateRecipes}
	 */
	public static void generateRecipes(RecipeOutput p_301014_, BlockFamily p_176582_, FeatureFlagSet p_313799_) {
		RecipeProvider.generateRecipes(p_301014_, p_176582_, p_313799_);
	}
	...
	public static Block getBaseBlock(BlockFamily p_176524_, BlockFamily.Variant p_176525_) {
		return RecipeProvider.getBaseBlock(p_176524_, p_176525_);
	}
	...
	public static Criterion<InventoryChangeTrigger.TriggerInstance> has(MinMaxBounds.Ints p_176521_, ItemLike p_176522_) {
		return RecipeProvider.has(p_176521_, p_176522_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#has}
	 */
	public static Criterion<InventoryChangeTrigger.TriggerInstance> has(ItemLike p_125978_) {
		return RecipeProvider.has(p_125978_);
	}

	/**
	 * Generated override to expose protected method: {@link RecipeProvider#has}
	 */
	public static Criterion<InventoryChangeTrigger.TriggerInstance> has(TagKey<Item> p_206407_) {
		return RecipeProvider.has(p_206407_);
	}
