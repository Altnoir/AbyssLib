...
public class ReginthLegacyBlockModelBuilder {
	...
	ReginthLegacyBlockModelBuilder(BiConsumer<Identifier, ModelInstance> output, ExtendedModelTemplateBuilder template, TextureMapping texture) {
		this.output = output;
		this.template = template;
		this.texture = texture.copy();
	}

	public ReginthLegacyBlockModelBuilder texture(TextureSlot slot, Material texture) {
		this.template.requiredTextureSlot(slot);
		this.texture.put(slot, texture);
		return this;
	}

	public ReginthLegacyBlockModelBuilder transformTemplate(Consumer<ExtendedModelTemplateBuilder> action) {
		action.accept(template);
		return this;
	}

	public ReginthLegacyBlockModelBuilder transformTexture(Consumer<TextureMapping> action) {
	 ...
	 */
	public ReginthLegacyBlockModelBuilder parent(Identifier parent) {
	 ...
	 */
	public ReginthLegacyBlockModelBuilder suffix(String suffix) {
	 ...
	 */
	public ReginthLegacyBlockModelBuilder transform(ItemDisplayContext type, Consumer<TransformVecBuilder> action) {
	 ...
	 */
	public ReginthLegacyBlockModelBuilder ambientOcclusion(boolean ambientOcclusion) {
	 ...
	 * </ul>
	 */
	public ReginthLegacyBlockModelBuilder guiLight(UnbakedModel.GuiLight light) {
	 ...
	 */
	public <L extends CustomLoaderBuilder> ReginthLegacyBlockModelBuilder customLoader(Supplier<L> customLoaderFactory, Consumer<L> action) {
	 ...
	 */
	public ReginthLegacyBlockModelBuilder rootTransforms(Consumer<RootTransformsBuilder> action) {
