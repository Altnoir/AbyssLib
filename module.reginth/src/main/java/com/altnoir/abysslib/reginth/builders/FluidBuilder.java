...
public class FluidBuilder<T extends BaseFlowingFluid, P> extends AbstractBuilder<Fluid, T, P, FluidBuilder<T, P>> {
    ...
    public FluidBuilder<T, P> model(NonNullSupplier<Supplier<FluidModel.Unbaked>> model) {
        if (this.model == null) {
            ReginthDistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> this::registerModel);
        }
        this.model = model;
        return this;
    }
     ...
     * @see #create(AbstractReginth, Object, String, BuilderCallback, FluidTypeFactory, FluidFactory)
     */
    public static <P> FluidBuilder<BaseFlowingFluid.Flowing, P> create(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback) {
     ...
     * @see #create(AbstractReginth, Object, String, BuilderCallback, FluidTypeFactory, FluidFactory)
     */
    public static <P> FluidBuilder<BaseFlowingFluid.Flowing, P> create(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, FluidTypeFactory typeFactory) {
     ...
     * @see #create(AbstractReginth, Object, String, BuilderCallback, FluidTypeFactory, FluidFactory)
     */
    public static <P> FluidBuilder<BaseFlowingFluid.Flowing, P> create(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, NonNullSupplier<FluidType> fluidType) {
     ...
     * @return A new {@link FluidBuilder} with reasonable default data generators.
     */
    public static <T extends BaseFlowingFluid, P> FluidBuilder<T, P> create(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback,
    ...
    public FluidBuilder(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, FluidTypeFactory typeFactory, FluidFactory<T> fluidFactory) {
    ...
    public FluidBuilder(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, NonNullSupplier<FluidType> fluidType, FluidFactory<T> fluidFactory) {
        super(owner, parent, "flowing_" + name, callback, Registries.FLUID);
        this.sourceName = name;
        this.bucketName = name + "_bucket";
        this.fluidFactory = fluidFactory;
    ...
    public final FluidBuilder<T, P> tag(TagKey<Fluid>... tags) {
        ...
        if (this.tags.isEmpty()) {
            ret.getOwner().<ReginthTagsProvider.Intrinsic<Fluid>, Fluid>setDataGenerator(ret.sourceName, getRegistryKey(), ProviderType.FLUID_TAGS,
