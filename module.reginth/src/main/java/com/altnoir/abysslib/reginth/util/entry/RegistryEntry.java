...
/**
 * Extends {@link net.neoforged.neoforge.registries.DeferredHolder}, providing a cleaner API with null-safe access, and Reginth-specific extensions such as {@link #getSibling(ResourceKey)}.
 *
 * @param <S>
