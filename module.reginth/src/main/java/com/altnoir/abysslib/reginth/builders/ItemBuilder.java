...
import com.altnoir.abysslib.reginth.providers.generators.ReginthItemModelGenerator;
...
public class ItemBuilder<T extends Item, P> extends AbstractBuilder<Item, T, P, ItemBuilder<T, P>> {
     ...
     */
    public static <T extends Item, P> ItemBuilder<T, P> create(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, NonNullFunction<Item.Properties, T> factory) {
    ...
    protected ItemBuilder(AbstractReginth<?> owner, P parent, String name, BuilderCallback callback, NonNullFunction<Item.Properties, T> factory) {
     ...
     */
    public ItemBuilder<T, P> model(NonNullSupplier<NonNullBiConsumer<DataGenContext<Item, T>, ReginthItemModelGenerator>> cons) {
     ...
     * @see #setData(GeneratorType, NonNullBiConsumer)
     */
    public ItemBuilder<T, P> recipe(NonNullBiConsumer<DataGenContext<Item, T>, ReginthRecipeProvider> cons) {
