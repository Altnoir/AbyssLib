...
public class ReginthRecipeProvider extends RecipeProvider implements RecipeOutput {
    private final ReginthRecipeRunner runner;
    ...
    public ReginthRecipeProvider(ReginthRecipeRunner runner, HolderLookup.Provider registries, RecipeOutput output) {
    ...
    public <T extends ItemLike, S extends AbstractCookingRecipe> void cooking(DataIngredient source, RecipeCategory craftingCategory, CookingBookCategory cookingCategory, Supplier<? extends T> result, float experience, int cookingTime, String typeName, AbstractCookingRecipe.Factory<S> factory) {
        SimpleCookingRecipeBuilder.generic(source.toVanilla(), craftingCategory, cookingCategory, result.get(), experience, cookingTime, factory).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeId(result.get()) + "_from_" + safeName(source) + "_" + typeName);
    }
    ...
    public <T extends ItemLike> ShapelessRecipeBuilder singleItemUnfinished(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int required, int amount) {
        return shapeless(category, result.get(), amount).requires(source.toVanilla(), required).unlockedBy("has_" + safeName(source), source.getCriterion(this));
    }
    ...
    public <T extends ItemLike> void stairs(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group, boolean stone) {
        shaped(category, result.get(), 4).pattern("X  ").pattern("XX ").pattern("XXX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeKey(result.get()));
        if (stone) {
    ...
    public <T extends ItemLike> void slab(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group, boolean stone) {
        shaped(category, result.get(), 6).pattern("XXX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeKey(result.get()));
        if (stone) {
    ...
    public <T extends ItemLike> void fence(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        shaped(category, result.get(), 3).pattern("W#W").pattern("W#W").define('W', source.toVanilla()).define('#', Tags.Items.RODS_WOODEN).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeKey(result.get()));
    }
    ...
    public <T extends ItemLike> void fenceGate(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        shaped(category, result.get()).pattern("#W#").pattern("#W#").define('W', source.toVanilla()).define('#', Tags.Items.RODS_WOODEN).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeKey(result.get()));
    }

    public <T extends ItemLike> void wall(DataIngredient source, RecipeCategory category, Supplier<? extends T> result) {
        shaped(category, result.get(), 6).pattern("XXX").pattern("XXX").define('X', source.toVanilla()).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeKey(result.get()));
        stonecutting(source, category, result);
    }
    ...
    public <T extends ItemLike> void door(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        shaped(category, result.get(), 3).pattern("XX").pattern("XX").pattern("XX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeKey(result.get()));
    }
    ...
    public <T extends ItemLike> void trapDoor(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        shaped(category, result.get(), 2).pattern("XXX").pattern("XXX").define('X', source.toVanilla()).group(group).unlockedBy("has_" + safeName(source), source.getCriterion(this)).save(this, safeKey(result.get()));
    }
    ...
    public RecipeBuilder buttonBuilder(ItemLike result, Ingredient base) {
        return super.buttonBuilder(result, base);
    }
    ...
    public RecipeBuilder fenceBuilder(ItemLike result, Ingredient base) {
        return super.fenceBuilder(result, base);
    }
    ...
    public RecipeBuilder fenceGateBuilder(ItemLike result, Ingredient planks) {
        return super.fenceGateBuilder(result, planks);
    }
    ...
    public RecipeBuilder pressurePlateBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return super.pressurePlateBuilder(category, result, base);
    }
    ...
    public RecipeBuilder signBuilder(ItemLike result, Ingredient planks) {
        return super.signBuilder(result, planks);
    }
    ...
    public RecipeBuilder wallBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return super.wallBuilder(category, result, base);
    }
    ...
    public RecipeBuilder polishedBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return super.polishedBuilder(category, result, base);
    }
    ...
    public ShapedRecipeBuilder cutBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return super.cutBuilder(category, result, base);
    }
    ...
    public void smeltingResultFromBase(ItemLike result, ItemLike base) {
        super.smeltingResultFromBase(result, base);
    }
    ...
    public static String getHasName(ItemLike baseBlock) {
        return RecipeProvider.getHasName(baseBlock);
    }
    ...
    public static String getConversionRecipeName(ItemLike product, ItemLike material) {
        return RecipeProvider.getConversionRecipeName(product, material);
    }
    ...
    public static String getSmeltingRecipeName(ItemLike product) {
        return RecipeProvider.getSmeltingRecipeName(product);
    }
    ...
    public static String getBlastingRecipeName(ItemLike product) {
        return RecipeProvider.getBlastingRecipeName(product);
    }
    ...
    public void accept(final net.minecraft.resources.ResourceKey<net.minecraft.world.item.crafting.Recipe<?>> id, final net.minecraft.world.item.crafting.Recipe<?> recipe, final net.minecraft.advancements.AdvancementHolder advancement) {
        this.outputDelegated.accept(id, recipe, advancement);
    }

    public net.minecraft.advancements.Advancement.Builder advancement() {
        return this.outputDelegated.advancement();
    }

    public void includeRootAdvancement() {
        this.outputDelegated.includeRootAdvancement();
    }

    public void accept(final net.minecraft.resources.ResourceKey<net.minecraft.world.item.crafting.Recipe<?>> arg0, final net.minecraft.world.item.crafting.Recipe<?> arg1, final net.minecraft.advancements.AdvancementHolder arg2, final net.neoforged.neoforge.common.conditions.ICondition... arg3) {
        this.outputDelegated.accept(arg0, arg1, arg2, arg3);
    }

    public net.minecraft.data.recipes.RecipeOutput withConditions(final net.neoforged.neoforge.common.conditions.ICondition... conditions) {
        return this.outputDelegated.withConditions(conditions);
    }
    // GENERATED END
}
