...
public class ReginthItemModelGenerator extends ItemModelGenerators {

    private final AbstractReginth<?> parent;

    public ReginthItemModelGenerator(AbstractReginth<?> parent, ItemModelOutput output, BiConsumer<Identifier, ModelInstance> model) {
        super(output, model);
        this.parent = parent;
    }
     ...
     * @param item A supplier to the bucket item, most commonly a {@link com.altnoir.abysslib.reginth.providers.DataGenContext}
