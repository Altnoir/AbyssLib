...
public class ReginthItemTagsProvider extends ReginthTagsProvider.IntrinsicImpl<Item> {
    ...
    public ReginthItemTagsProvider(AbstractReginth<?> owner, ProviderType<ReginthItemTagsProvider> type, String name, PackOutput output, CompletableFuture<HolderLookup.Provider> registriesLookup, CompletableFuture<TagsProvider.TagLookup<Block>> blockTags) {
