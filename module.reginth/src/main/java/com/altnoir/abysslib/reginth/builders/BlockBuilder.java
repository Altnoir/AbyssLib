...
import com.altnoir.abysslib.reginth.providers.GeneratorType;
...
import com.altnoir.abysslib.reginth.providers.generators.ReginthBlockModelGenerator;
import com.altnoir.abysslib.reginth.providers.generators.ReginthRecipeProvider;
...
public class BlockBuilder<T extends Block, P> extends AbstractBuilder<Block, T, P, BlockBuilder<T, P>> {
    ...
    /**
     * Assign the default blockstate, which maps all states to a single model file (via {@link ReginthBlockModelGenerator#createTrivialCube(Block)}). This is the default, so it is generally not necessary
     ...
     */
    public BlockBuilder<T, P> blockstate(NonNullSupplier<NonNullBiConsumer<DataGenContext<Block, T>, ReginthBlockModelGenerator>> cons) {
